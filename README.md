...
- 12-Hour Draft Clock. Each scheduled pick receives a 12-hour clock.
...
Potential v1.3 improvements currently included:

    Implement Keeper support with Keeper Streak rules
    Remove the /export-draft command and implement a /sync-draft-to-espn command that would allow the Commissioner to write the draft results into ESPN Fantasy Football
    Minor architectural improvement to have the ESPN_YEAR .env variable not be needed
